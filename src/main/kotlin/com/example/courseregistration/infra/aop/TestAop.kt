...
//@Aspect  // Aspect 정의 시 사용. 사용 안할 땐 빈 떼버리면 됨
//@Component // bean 으로 등록
class TestAop {

    // JoinPoint 를 기준으로 정확히 어느 위치에 적용 되는지
    // pointcut Expression, Pointcut Designator : execution, annotaion ...   //.*(..) 모든 메서드 // .. : 인자가 1개
    // joinpoint가 실행되는 곳 의 앞뒤로 명령어 설정 . pointcut 설정
